...
\bibitem{book}Floerkemeier, C., Langheinrich, M., Fleisch, E., Mattern, F., \& Sarma, S. E. (Eds.). (2008). The Internet of Things: First International Conference, IOT 2008, Zurich, Switzerland, Proceedings (Vol. 4952). springer.
...
\bibitem{discovery}Zaslavsky, A., \& Jayaraman, P. P. (2015). Discovery in the Internet of Things. 
 ...
 \bibitem{por}Porkodi, R., \& Bhuvaneswari, V. (2014). The internet of things (IOT) applications and communication enabling technology standards: An overview. 

.
 \bibitem{SRA}Tarkoma, S., \& Katasonov, A. (2011). Internet of things strategic research agenda (IoT–SRA). 
 
  
 \bibitem{por1}Porkodi, R., \& Bhuvaneswari, V. (2014). The internet of things (IOT) applications and communication enabling technology standards: An overview. 
 
 \bibitem{por2}Porkodi, R., \& Bhuvaneswari, V. (2014). The internet of things (IOT) applications and communication enabling technology standards: An overview. 
 
 \bibitem{azori}Atzori, L., Iera, A., \& Morabito, G. (2010). The internet of things: A survey. Computer networks.

 \bibitem{por3}Porkodi, R., \& Bhuvaneswari, V. (2014). The internet of things (IOT) applications and communication enabling technology standards: An overview. 
 
  \bibitem{por4}Porkodi, R., \& Bhuvaneswari, V. (2014). The internet of things (IOT) applications and communication enabling technology standards: An overview. 
  
    \bibitem{por5}Porkodi, R., \& Bhuvaneswari, V. (2014). The internet of things (IOT) applications and communication enabling technology standards: An overview. 
    
      \bibitem{por6}Porkodi, R., \& Bhuvaneswari, V. (2014). The internet of things (IOT) applications and communication enabling technology standards: An overview. 
  
   \bibitem{SRA1}Tarkoma, S., \& Katasonov, A. (2011). Internet of things strategic research agenda (IoT–SRA). 
   
   
 \bibitem{App1}Asghar, M. H., Negi, A., \& Mohammadzadeh, N. (2015, May). Principle application and vision in Internet of Things (IoT). 
...
\bibitem{amzonalexa} Wikimedia Foundation. (2021, December 21). Amazon alexa. Wikipedia. Retrieved December 21, 2021, from https://en.wikipedia.org/wiki/Amazon\_Alexa 
...
\bibitem{art}Art Hicks, webmaster@kmccontrols.com. (n.d.). Understanding building automation and control systems -KMC controls. Retrieved December 21, 2021

\bibitem{control}KMC Controls.(May 2013) "Understanding Building Automation and Control Systems". 


\bibitem{art1}Art Hicks, webmaster@kmccontrols.com. (n.d.). Understanding building automation and control systems -KMC controls. Retrieved December 21, 2021

\bibitem{control1}KMC Controls.(May 2013) "Understanding Building Automation and Control Systems". 


\bibitem{art2}Art Hicks, webmaster@kmccontrols.com. (n.d.). Understanding building automation and control systems -KMC controls. Retrieved December 21, 2021
...
\bibitem{micro} Spachos, P., Papapanagiotou, I., \& Plataniotis, K. N. (2018). Microlocation for smart buildings in the era of the internet of things: A survey of technologies, techniques, and approaches. IEEE Signal Processing Magazine, 35(5), 140-152.
...
\bibitem{mic1}Zafari, F., Papapanagiotou, I., \& Christidis, K. (2015). Microlocation for internet-of-things-equipped smart buildings. 
